...
encoder_Course = joblib.load('/content/model/encoder_Course.joblib')
...
encoder_Marital_status = joblib.load('/content/model/encoder_Marital_status.joblib')
...
encoder_Previous_qualification = joblib.load('/content/model/encoder_Previous_qualification.joblib')
