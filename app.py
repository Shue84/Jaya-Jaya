...
import pandas as pd
import joblib
from data_preprocessing import data_preprocessing, encoder_Course_Marital_status_Previous_qualification, encoder_Daytime_evening_attendance, encoder_Fathers_occupation, encoder_Fathers_qualification, encoder_Gender, encoder_Marital_status, encoder_Mothers_occupation, encoder_Mothers_qualification, encoder_Previous_qualification, encoder_Scholarship_holder
...
onehot_encoder = joblib.load('/model/onehot_encoder.joblib')  # Replace with your file path
